...
SELECT 'Estrutura da table' AS 'PRINT DADO';
...
VALUES('Corinthians', 4), ('Atlético', 6), ('Coxa', 6), ('São Paulo', 4);
...
ADD COLUMN campeonato enum('brasileiro', 'paranaense', 'paulista') NOT NULL DEFAULT 'brasileiro' AFTER gols;
...
UPDATE time_futebol SET ponto_campeonato = 25;

ALTER TABLE time_futebol MODIFY COLUMN ponto_campeonato FLOAT;
DESCRIBE time_futebol;

UPDATE time_futebol SET ponto_campeonato = 25.2;
